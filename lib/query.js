...
async function loadData(dbPath) {
  ...
  try {
    ...
    console.error("Failed to read database file:", readErr.message);
    throw new Error("Cannot read database file: " + readErr.message);
  }
  ...
  try {
    ...
    console.error("Failed to open database:", dbErr.message);
    throw new Error("Cannot open database: " + dbErr.message);
  }
